...
# NAAIM
naaim_date = end.date() - datetime.timedelta(days=1)
naaim_df = pd.read_excel(f"https://www.naaim.org/wp-content/uploads/2023/01/USE_Data-since-Inception_{naaim_date}.xlsx", index_col=0).iloc[::-1].tail(104)
